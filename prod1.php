<?php
    ...
    {
        $prod_id = 10001;
        $prod_name = "Body Soul - Mogra Premium Incense Sticks";
        $prod_amt = 100;
...
<head>
    ...
    <title>Body Soul - Mogra Premium Incense Sticks</title>
...
<style type="text/css">
    ...
    <!--
    <center>
    <h1>Body Soul - Mogra Premium Incense Sticks</h1>
    </center>
    <br>
    -->
    <center>
    <table>
        <tr>
            <td></td>
            <td><img src="prod_images/prod1.png" width="500"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td>
                <h3>Body Soul - Mogra Premium Incense Sticks</h3>
