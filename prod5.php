<?php
    ...
    {
        $prod_id = 10005;
        $prod_name = "Svahaa Certified Kalash";
        $prod_amt = 500;
...
<head>
    ...
    <title>Svahaa Certified Kalash</title>
...
<!--
    ...
    <table>
        <tr>
            <td></td>
            <td><img src="prod_images/prod5.jpeg" width="500"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td>
                <h3>Svahha Certified Kalash</h3>
                <center><h5>₹500.00</h5></center>
                <br>
                <center>
                <form method="post">
